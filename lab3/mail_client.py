...
SERVER = 'http://172.20.10.13:5000' # rasbery pi
...
def get_inbox(recipient: str) -> None:
    """
    Sends a recipient name via GET request to server and get list of mails
    addressed toward the recipient
...
def get_sent(sender: str) -> None:
    """
    Sends a sender name via GET request to server and get list of mails
    sent by the sender
...
def get_mail(mail_id: str) -> None:
    """
    Sends a mail_id via GET request to server and get the corresponding mail entry
...
def delete_mail(mail_id: str) -> None:
    """
    Sends a mail_id via DELETE request to server and delete the corresponding mail entry
